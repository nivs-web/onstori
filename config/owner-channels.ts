...
export const OWNER_CHANNELS: OwnerChannelDef[] = [
  ...
  {
    /**
     * ★★ **서브 홈페이지** — 2026-09-15 대표님 지시로 신설.
     *
     * ★ 대표님 말씀: 「홈페이지 주소가 2개가 되니까 **그 부분은 (메인으로) 넣지 않는 걸로** 하자. …
     *   그래도 **불러와서 입력이 되는 부분은 구현해 놔.** 「서브홈페이지」라는 항목으로 URL 긁어와서
     *   채널로 연동시키고, **쓸라면 쓰고 지우려면 지우게** 하고, 개별적으로 우리 직원들이 전화해서
     *   그 부분은 수정하시는 게 마케팅에 더 좋고 유리합니다 라고 설명하는 쪽으로 할게.」
     *
     * ⚠ **소상공인에게 홈페이지 주소가 둘이면 안 된다.** 그래서 «메인»으로 쓰지 않고
     *   채널 위젯의 한 칸으로만 둔다. 지우고 싶으면 칸을 비우시면 된다.
     */
    id: "homepage",
    label: "기존 홈페이지 (서브)",
    hint: "쓰시던 홈페이지가 있으면 여기에 둡니다. 안 쓰실 거면 비워 두세요 — 주소가 둘이면 손님이 헷갈립니다.",
    placeholder: "https://내가게.co.kr",
    mark: "W", color: "#5F6B69",
  },
  {
    id: "smartStore",
