      ...
      <div className="mx-auto flex min-h-svh max-w-md flex-col px-5 pb-10 pt-6">
        ...
        {screen === "review" && (
          <section className="flex flex-1 flex-col">
            ...
            <p className="mt-3 text-center t-caption opacity-60">보내면 온스토리가 무음을 자르고 자막을 넣어 영상·글로 만듭니다</p>
          </section>
        )}
        ...
        {screen === "done" && (
          <section className="flex flex-1 flex-col items-center justify-center text-center">
            ...
            <p className="mt-3 max-w-xs t-small leading-relaxed opacity-80">자막 영상과 다듬은 글은 30분쯤 뒤 문자로 보내드릴게요. 홈페이지 블로그와 6개 채널에 올릴 준비가 되면 알려 드립니다.</p>
