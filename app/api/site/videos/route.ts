...
import { SHORTS_MAX, shortsStyleOf, shortsOrderOf, stageNOf, cardsNOf } from "@/config/shorts";
...
export async function POST(req: Request) {
  ...
  return NextResponse.json({ items, softDeleteReady, attachedTotal, shortsStyle: shortsStyleOf(r.site.settings), shortsOrder: shortsOrderOf(r.site.settings), stageN: stageNOf(r.site.settings), cardsN: cardsNOf(r.site.settings) });
}
