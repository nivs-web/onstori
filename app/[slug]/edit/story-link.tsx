  ...
  return (
    <section className="mt-4 rounded-xl p-3" style={{ background: "var(--forest)", color: "var(--cream)" }}>
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button type="button" onClick={go} disabled={busy} className="shrink-0 rounded-full px-3.5 py-1.5 t-caption font-bold disabled:opacity-50" style={{ background: "var(--lime)", color: "var(--forest)" }}>
