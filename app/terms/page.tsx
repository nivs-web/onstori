/* 기간 출처: lib/trial.ts — 아래 「시행 7일/30일 전」은 **약관 변경 예고 기간**이라 요금 기간과 무관하다 */
      ...
      <div className="wrap max-w-3xl pb-24">
        ...
        <Sec n="4" title="요금과 무료 기간">
          ...
          <p>
            ...
            <b>{LEGAL.lifecycle}</b>{" "}
            손님이 남긴 견적 문의는 정지일로부터 {INQUIRY_RETENTION_DAYS}일이 지나면 파기합니다.
            자료 보관·삭제 기준은{" "}
        ...
        <Sec n="11" title="해지">
          <p>
            {/* ⚠ 2026-09-13 — 전에는 「수정 화면에서」라고 적혀 있었다. **틀렸다.**
                해지 버튼은 app/my/ui.tsx(마이페이지)에만 있고 수정 화면에는 「해지」라는 글자조차 없다.
                제5조⑤가 이미 「마이페이지」라고 맞게 적고 있어 한 약관이 스스로 두 말을 하고 있었다.
                ★ 없는 버튼을 가리키는 약관은 전자상거래법 제21조의2(가입만큼 쉬운 해지)를
                  «지킨 척»만 하는 것이다. */}
        ...
        <Sec n="13" title="약관이 바뀔 때">
          ...
          <p className="t-body" style={{ color: "var(--muted)" }}>시행일: {UPDATED}</p>
        </Sec>
