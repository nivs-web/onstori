        ...
        <div className="wrap">
          ...
          <ol className="grid md:grid-cols-4" style={{ marginTop: "var(--s-7)", gap: "var(--s-4)" }}>
            {[
              ...
              /* ★ 2026-09-12 회장님 확정(A안) — 전에는 「30분 안에 자막 영상·다듬은 글 3종·사진 카드」였다.
                 **넷 다 없다**(자막 워커·글 3종·사진 카드 전부 미착수). 지금 되는 것만 말한다. */
              ["찍는 즉시 홈페이지에 올라갑니다", "영상이 사장님 홈페이지에 바로 걸립니다. 무슨 말을 해야할지 고민하지 마세요. 쉽게 선택 가능한 질문 카드를 제공합니다."],
              /* ⚠ 4번도 같은 문제였다 — 「6곳에 퍼지고 쌓입니다」인데 **지금 나가는 곳이 없다.**
                 진짜 되는 것은 «홈페이지에 쌓이는 것»이라 그것을 앞세우고 나머지는 준비 중으로 적는다. */
              ["홈페이지에 차곡차곡 쌓입니다", "이야기가 늘수록 검색에 잡히는 페이지가 늘어납니다. 인스타그램 함께 올리기가 먼저 열리고, 나머지 채널도 준비 중입니다."],
            ].map(([t, d], i) => (
