...
export default async function SubdomainsAdmin() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl min-w-0 px-6 py-10">
      <h1 className="mt-1 t-h3 font-bold">서브도메인 만들기</h1>
      <div className="mt-6 rounded-2xl border border-dashed border-n-300 p-6 t-small leading-relaxed text-[var(--text-soft)]">
