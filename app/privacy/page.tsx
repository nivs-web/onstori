 ...
 *    사업자등록번호 139-24-01865 · 주소 경기도 남양주시 다산순환로 397-80, 401.
 * ⚠ 통신판매업신고번호만 아직 없어 "신고 진행 중 (발급 후 게시)" 임시 문구로 두고 공개했다
 *    (2026-09-06 회장님 결정 — Meta 심사·토스 가맹이 공개 URL 을 요구한다, DECISIONS 참조).
 *    발급되면 §1 의 그 문구 한 줄만 실제 번호로 바꾼다.
    ...
    <main className="min-h-svh" style={{ background: "var(--cream)", color: "var(--ink)" }}>
      ...
      <div className="wrap max-w-3xl pb-24">
        <Sec n="1" title="누가 운영하나요">
          <p>
            온스토리(onstori.com)는 이안월드가 운영합니다. 대표 권병철 · 사업자등록번호 139-24-01865 ·
            통신판매업신고 신고 진행 중 (발급 후 게시) · 주소 경기도 남양주시 다산순환로 397-80, 401.
          </p>
          <p>
