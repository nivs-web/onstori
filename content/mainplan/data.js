/* 금액 출처: lib/trial.ts — 이 화면의 숫자는 그 값을 옮겨 적은 것이다 */
...
<div class="card dark">
  <b>한 문장 정의</b><br>
  사장님은 <mark>글을 쓰지 않는다</mark>. 문자로 온 <mark>링크만 누르고</mark>(카톡 로그인), <mark>앱 설치 없이</mark> 크롬에서 60초 녹화한다. 온스토리가 그 60초를 자막 영상·글·사진 카드로 만들어 유튜브 쇼츠·인스타 릴스·X·쓰레드·네이버 블로그(복붙 30초)·온스토리 사이트 6곳에 퍼뜨린다.
</div>
...
<tr><td>6</td><td>14일 무료 → 차단 → 토스 49,900원 결제 모달 (키 등록 전까지 '준비 중' 표시) · 만료 크론</td><td>중</td><td><span class="tag done">완료(키 대기)</span></td></tr>
...
<tr><td>상단 띠</td><td>오픈 기념 — 14일 전 기능 무료, 이후 49,900원</td><td>클릭 → /new</td></tr>
<tr><td>퍼지는 곳</td><td>한 번 말하면 6곳으로</td><td>유튜브 쇼츠 · 인스타 릴스 · 쓰레드 · X · 네이버 블로그 · 온스토리 사이트</td></tr>
...
<tr><td>가격 카드</td><td>정회원 49,900원</td><td>포함 6가지 + 14일 무료 + 언제든 해지</td></tr>
...
<tr><td>상단 프로모 띠 "Get $10 off…"</td><td>"오픈 기념 — 14일 전 기능 무료 · 이후 49,900원" (서브색 #273D3D 얇은 띠, 흰 글자)</td></tr>
...
<tr><td>10</td><td>Best-seller $99 카드</td><td>정회원 49,900원 카드 — 포함 6가지 · 14일 무료 · 해지 자유</td><td>02</td><td><span class="tag done">완료</span></td></tr>
...
<tr><td>온스토리 사이트</td><td>story_entries → /[slug] 스토리 피드 + /[slug]/story/[id]</td><td>720px 스토리 페이지</td><td>무료. 검색 인덱싱의 본진</td></tr></table>
...
<li><b>6곳에 퍼집니다</b> — 유튜브 쇼츠 · 인스타 릴스 · 쓰레드 · X(유료) · 네이버 블로그(복사 30초) · 온스토리 사이트. 하루 최대 3건.</li>
...
<h3>CTA</h3><p>[녹화를 시도해보세요 · 60초] → /new · "14일 전 기능 무료 · 이후 49,900원 · 언제든 해지"</p>
`},
...
<h3>원칙 5개</h3>
<ol><li>사장님은 글을 쓰지 않는다.</li><li>없는 사실을 만들지 않는다 — 연차·건수·후기·별점을 지어내지 않는다.</li><li>사장님이 찍은 것이 우선이다. AI 사진은 빈자리를 채울 뿐이다.</li><li>홈페이지·영상·기록은 전부 사장님 것이다. 해지해도 가져간다.</li><li>가격은 처음부터 공개한다. 14일 무료, 이후 49,900원.</li></ol>
`},
...
<h3>2. 요금 · 정회원</h3>
<p><b>얼마인가요?</b> — 14일 동안 전 기능 무료. 14일 안에 정회원(49,900원)으로 전환하시면 홈페이지가 계속 유지됩니다. 14일이 지나면 자동으로 삭제됩니다.</p>
...
<h3>5. 결과물 · 발행</h3>
<p><b>어디에 올라가나요?</b> — 유튜브 쇼츠 · 인스타 릴스 · 쓰레드 · X(유료) · 네이버 블로그(복사 30초) · 온스토리 사이트.</p>
...
{ id: "blog", group: "메뉴 페이지", title: "블로그 (/blog 구조 · 6분류 · 첫 12편)",
  lead: "레멘토 블로그: 6카테고리 · 카드 그리드 · 리드 매그닛. 블로그는 두 층 — 온스토리 본사 블로그(여기)와 사장님의 온스토리 사이트.",
  html: `
<h3>6분류</h3>
...
<tr><td>비용</td><td>제작 50~300만원 + 유지비</td><td>14일 무료 → 49,900원</td></tr>
...
<p>홈온과 비슷한 형태이되 14일 전 기능 사용. 상단에 무료 남은 기간 바 + [정회원 이용하기]. 14일 뒤엔 차단 화면 + 토스 49,900원 모달.</p>
`},
...
{ id: "membership", group: "온보딩·정회원", title: "14일 무료 · 정회원 · 결제 · 회원 목록",
  lead: "트라이얼 14일 → 차단 → 토스페이먼츠 49,900원. 운영자 회원 목록은 결제·만료·연락을 한 화면에서.",
  html: `
<h3>규칙</h3>
...
<li>결제: 토스페이먼츠 결제위젯(1회 49,900원). 서버가 금액 재계산(규칙 4). 키(<code>TOSS_CLIENT_KEY</code>·<code>TOSS_SECRET_KEY</code>)가 없으면 모달은 "결제 준비 중 — 카카오톡 채널로 문의"를 보여준다.</li>
<li>월 9,900원 유지비(기존 가격 정책)는 <b>회장님 결정 대기</b>: 이번 기획엔 "정회원 49,900원"만 확정. 화면엔 49,900원만 표시하고 월 요금은 언급하지 않았다.</li></ul>
