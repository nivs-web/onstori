...
- **첫 페이지·메뉴**: remento.co 의 구조·레이아웃·메뉴·마케팅 장치를 1:1로 옮기고 내용만 온스토리. 색은 포레스트 #1E332D · 크림 #F4F0E6 · 라임 #E1EB6E(로고 ON 그린 #005B2A 과 같은 계열). 기존 섹션(포트폴리오·3단계·차별점·가격 밴드)은 삭제하지 않고 자리만 재배치 — 삭제는 회장님 결정.
