...
> 회장님 지시로 무인 진행. **main push·merge·`supabase db push` 금지** — 전부 브랜치에만 커밋.
> 각 항목은 완료 조건 검증 후 ✅, 판단이 안 서면 `보류: (이유)` 로 남기고 다음으로 넘어간다.

| # | 항목 | 브랜치 | 상태 |
|---|---|---|---|
| 0 | 준비 — handoff 스펙 A~G 를 `docs/specs/` 로 반입 | `docs/handoff-specs-2026-09-06` | ⏳ |
| 1 | A/B/D — 문구·메뉴·아이콘 · 숨은 에디터 진입로 · 60초 촬영 안내 | `feat/copy-menu-2026-09-06` · `feat/rec-guide-2026-09-06` | ⏳ |
| 2 | G — 개인정보처리방침·이용약관 빈칸 채우기 | `feat/legal-pages-2026-09-06` | ⏳ |
| 3 | 이미지뱅크 **히어로만** 재생성 — 비용 재계산 먼저 | — | ⏳ |
| 4 | 테스트 사이트 정리 — `interior2` 만 남기고 8개 삭제 | — | ⏳ |
| 5 | Meta 개발자 앱 | — | ⏳ |
