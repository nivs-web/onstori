...
| 1 | A/B — 문구·메뉴·아이콘 · 숨은 에디터 진입로 | `feat/copy-menu-2026-09-06` | ✅ |
...
⚠ **눈으로만 확인 가능한 것 5개는 남아 있다** — 아이폰/안드로이드 홈화면 아이콘(§9-4·5), 채널 띠 아이콘 6개 크기(§9-6), 커서가 손가락으로 안 바뀌는지(§9-14), 자간 변경 뒤 6개 화면의 줄바꿈(§6 경고). 로컬 `npm run dev` 로 한 번 훑어 주십시오.
