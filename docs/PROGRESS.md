...
**코드만 놓고 보면 막힘 없이 지금 손댈 수 있는 건 ③·④·⑤다.** ①②는 사장님 판단이 있어야 움직이고, ⑥은 P7로 미루기로 이미 정했다.

크레딧 확인(2026-09-02)도 걸려 있다 — 오늘 사용분 약 $16이 크레딧 차감인지 카드 청구인지에 따라 남은 이미지 웨이브 방침이 갈린다. 맨 아래 "코딩 외 대기 항목" 참조.
