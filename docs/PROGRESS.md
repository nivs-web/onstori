...
| ~~③~~ | ~~**남은 이미지 웨이브 — 비히어로**~~ ✅ **2026-09-02 완료**(갤러리·시공사례·about·process, Flash 모델) | 운영 | 없음. **크레딧 확인으로 막혀 있던 게 2026-09-01 풀렸다.** 뱅크 131장 중 124장이 hero라 비히어로가 사실상 비어 있고, 그동안은 Unsplash 플레이스홀더로 폴백한다. 크레딧 만료 **2026-12-01** — 안 쓰면 사라진다. 생성 후 `/admin/bank`에서 검수·승인해야 실제로 쓰인다(생성분은 전부 검수 대기로 들어간다) |
