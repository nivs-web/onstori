...
- [~] **P4 진행 중(2026-09-01 착수)** — 완료: 카카오 OAuth+이메일 OTP 로그인·anon claim·owner_id 소유 게이트·@supabase/ssr 세션(미들웨어 없음) / 남음: Supabase 대시보드 설정(docs/auth-setup.md)·로그인 E2E·에디터 로그인 유도 배너·운영자 화이트리스트 검토 (PROGRESS "P4" 섹션 참조)
- [ ] P5 결제(토스)+플랜 게이팅
