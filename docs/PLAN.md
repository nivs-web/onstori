...
**단일 출처는 기획1 `onstori.com/mainplan`** (content/mainplan/data.js · 운영자 전용). 완성/남은 작업·STEP 0~8·파일 목록이 거기 있다. 이 파일의 Phase 표는 그 이전 로드맵이며, P5(결제)는 "14일 무료→정회원 49,000원"으로 대체됐다.
...
3. ✅ 전화·카톡 버튼이 스크롤 어디서나 눌린다 (플로팅 연결 위젯) — 2026-09-05 구현·검증 완료. 남은 확인 하나: 실제로 발행한 사이트를 실기기에서 눌러보는 것(테스트 사이트를 발행할 수 없어 388px 미리보기까지만 확인)
