...
⚠ 지금 결제는 **토스 1회 승인**이다(빌링키·정기결제 코드 없음, `lib/trial.ts:6` `MEMBERSHIP_PRICE` 1회 49,900원).
...
> ⚠ 2026-09-06 **최종** 확정(월 49,900원 구독 · **30일 무료** · 정지 · **정지 후 60일 삭제**)에 맞춰 재검토 필요. 정책 단일 출처: `lib/trial.ts`.
