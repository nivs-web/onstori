...
> ⛔ **이 절은 폐기됐다 (2026-09-06 최종 확정).** 아래 7곳의 문구는 사실과 달라 표시광고 위험이었고 전부 제거했다.
> 현재 정책: 무료 **30일** → 정지(자료 보관) → **정지 후 60일** 삭제. 단일 출처 `lib/trial.ts`.
...
- 어드민 화면 — **E 스프린트.**
- ~~"14일 이후 자동 삭제" 문구 7곳 — 회장님이 그대로 두라고 하셨다(결정 1).~~ ⛔ **폐기됨(2026-09-06)** — 전부 제거했다.
