...
> ⚠ 2026-09-06 확정안 반영 필요: 무료 기간은 **14일**이고 미결제 시 D+14 정지 → D+28 자동 삭제다.
> 연장 버튼의 기본값 30일은 무료 기간(14일)보다 길어 오해를 부른다. 연장 시 정지·삭제 일정이 함께 밀린다는 점도 문구에 넣어야 한다. 정책 단일 출처: `lib/trial.ts`.
