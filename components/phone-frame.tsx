...
export function PhoneFrame({ slug, scale = 0.62, title }: { slug: string; scale?: number; title?: string }) {
  return (
    <div className="rounded-[2.4rem] border border-black/10 bg-n-900 p-[9px] shadow-[0_24px_60px_-20px_rgba(23,25,29,0.45)]">
      <div className="relative overflow-hidden rounded-[1.9rem] bg-white">
        <div className="absolute left-1/2 top-1.5 z-10 h-[18px] w-[86px] -translate-x-1/2 rounded-full bg-n-900" />
