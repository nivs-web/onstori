  ...
  return (
    ...
    >
      ...
      <p className="t-body" style={{ marginTop: "var(--s-3)", color: "var(--muted)", maxWidth: "32rem" }}>
        {/* ⚠ 2026-09-13 — 「급하시면 가게에 직접 연락해 주세요」를 뺐다(상무님 지적 12).
            전화번호가 기본 비공개라 **연락할 방법을 못 싣는다.** 방법도 없이 연락하라는 말은
            손님을 헛걸음시킨다.
            ⚠ 「곧」은 금지어다 — 언제인지 모르면서 곧이라고 하면 그것도 거짓말이다. */}
        잠시 쉬고 있는 홈페이지예요. 다시 열릴 예정입니다.
      </p>
